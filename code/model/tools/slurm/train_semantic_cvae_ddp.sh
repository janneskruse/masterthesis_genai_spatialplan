...
#SBATCH --time=3:00:00
#SBATCH --job-name="train_cvae_inpainting_semantic_ddp"
#SBATCH --nodes=1
...
# Parse arguments
CONFIG_PATH="cvae_inpainting.yml"
CHECKPOINT_PATH=""
...
PYTHON_CMD="python3 -u ../train_cvae_inpainting_ddp.py --config $CONFIG_PATH --mode semantic"
if [ -n "$CHECKPOINT_PATH" ]; then

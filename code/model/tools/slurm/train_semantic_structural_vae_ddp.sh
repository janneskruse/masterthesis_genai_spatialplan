...
#SBATCH --time=3:00:00
#SBATCH --job-name="train_vae_semantic_structural_ddp"
#SBATCH --nodes=1
...
PYTHON_CMD="python3 -u ../train_vae_ddp.py --config $CONFIG_PATH --mode semantic_structural"
if [ -n "$CHECKPOINT_PATH" ]; then
